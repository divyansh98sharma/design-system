...
@Component({
  selector: 'ds-encounter-lookup',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './encounter-lookup.component.html',
  styleUrl: './encounter-lookup.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EncounterLookupComponent {
  @Input() label = 'Encounter Lookup';
  @Input() placeholder = 'Search Encounter Lookup';
