...
@Component({
  selector: 'ds-facility-lookup',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './facility-lookup.component.html',
  styleUrl: './facility-lookup.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FacilityLookupComponent {
  @Input() label = 'Facility Lookup';
  @Input() placeholder = 'Search Facility Lookup';
