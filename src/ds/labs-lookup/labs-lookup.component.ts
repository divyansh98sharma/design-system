...
@Component({
  selector: 'ds-labs-lookup',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './labs-lookup.component.html',
  styleUrl: './labs-lookup.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LabsLookupComponent {
  @Input() label = 'Labs DI Procedure Lookup';
  @Input() placeholder = 'Search Labs DI Procedure Lookup';
