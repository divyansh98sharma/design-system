...
@Component({
  selector: 'ds-pharmacy-lookup',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './pharmacy-lookup.component.html',
  styleUrl: './pharmacy-lookup.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PharmacyLookupComponent {
  @Input() label = 'Pharmacy Lookup';
  @Input() placeholder = 'Search Pharmacy Lookup';
