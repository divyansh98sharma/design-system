...
@Component({
  selector: 'ds-specialty-lookup',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './specialty-lookup.component.html',
  styleUrl: './specialty-lookup.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SpecialtyLookupComponent {
  @Input() label = 'Specialty Lookup';
  @Input() placeholder = 'Search Specialty Lookup';
